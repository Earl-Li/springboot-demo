...
public class RequestController {
    ...
    public Map<String,Object> success(@RequestAttribute(value = "msg",required = false) String msg,
        ...
        /**Map集合流式编程同时遍历key和value*/
        map.forEach((key,value)->{
            System.out.println(key+" | "+value);
        });
        return map;//{"reqMethod_msg":"成功了...","annotationMethod_code":200}
        //{"reqMethod_msg":null,"msg":null,"annotationMethod_code":null,"world":"hello666",
        // "hello":"world666","message":"HelloWorld"}
    }
    @GetMapping("/params")
    public String testParam(Map<String,Object> map,
        ...
        cookie.setDomain("localhost");//cookie的setDomain方法不懂
